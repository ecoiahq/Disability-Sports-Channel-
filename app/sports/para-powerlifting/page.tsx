...
export const metadata: Metadata = {
  title: "Para Powerlifting | Disability Sports Channel",
  description:
    "Learn about para powerlifting, watch videos, read news, and discover the rules and classification system.",
}

export default function ParaPowerliftingPage() {
  const sport = getSportBySlug("para-powerlifting") || {
    name: "Para Powerlifting",
    description:
      "Para powerlifting is a Paralympic sport where athletes with physical disabilities compete in the bench press, testing upper body strength and technique.",
    timeline: [
      {
        year: "1964",
        event: "Paralympic Debut",
        description: "Weightlifting was first included in the Paralympic Games in Tokyo.",
      },
      {
        year: "1992",
        event: "Bench Press Only",
        description: "The sport was standardized to bench press only at the Barcelona Paralympics.",
      },
      {
        year: "2000",
        event: "Women's Events",
        description: "Women's para powerlifting was added to the Paralympic program in Sydney.",
      },
    ],
    rules: [
      {
        title: "Competition Format",
        content: "Athletes compete in the bench press only, with three attempts to achieve their maximum lift.",
      },
      {
        title: "Equipment",
        content: "Standard powerlifting bench and Olympic barbells are used, with athletes lying on their backs.",
      },
      { title: "Weight Classes", content: "Athletes compete in weight categories to ensure fair competition." },
    ],
    classification:
      "Para powerlifting has one sport class for all athletes with eligible physical impairments, with competition divided by weight categories and gender.",
    pointSystem:
      "Athletes have three attempts to achieve their maximum bench press. The highest successful lift determines the winner in each weight category.",
    coverImage: "/abstract-geometric-shapes.png",
  }

  const news = getSportNews("para-powerlifting") || []
  const videos = getSportVideos("para-powerlifting") || []
      ...
      <main className="flex-1">
        ...
        {timelineEvents.length > 0 && (
          <SportHistoryTimeline
            ...
            subtitle={`Explore the evolution of ${sport.name.toLowerCase()} from weightlifting to the specialized bench press competition.`}
          />
        )}
                ...
                <div className="grid gap-8 md:grid-cols-2">
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">Individual bench press</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-3">
                          <Clock className="mt-1 h-5 w-5 flex-shrink-0 text-teal-500" />
                          <div>
                            <p className="font-medium text-white">Attempts</p>
                            <p className="text-gray-400">Three attempts per athlete</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">1964 Tokyo Paralympics</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">World Para Powerlifting</p>
                          </div>
                        </li>
                      </ul>
                    </CardContent>
                  ...
                  <Card className="bg-gray-900 border-gray-800">
                    <CardContent className="p-6">
                      ...
                      <p className="mb-4 text-gray-300">Para powerlifting uses standard powerlifting equipment:</p>
                      <ul className="space-y-2 text-gray-300">
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Olympic barbell (20kg for men, 15kg for women)</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Weight plates in various denominations</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Powerlifting bench with safety bars</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Strapping for athletes who need it</span>
                        </li>
                      </ul>
                    </CardContent>
                  </Card>
