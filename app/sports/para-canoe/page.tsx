...
export const metadata: Metadata = {
  title: "Para Canoe | Disability Sports Channel",
  description: "Learn about para canoe, watch videos, read news, and discover the rules and classification system.",
}

export default function ParaCanoePage() {
  const sport = getSportBySlug("para-canoe") || {
    name: "Para Canoe",
    description:
      "Para canoe is a Paralympic sport where athletes with physical disabilities compete in sprint canoe and kayak events using adaptive equipment and techniques.",
    timeline: [
      {
        year: "2016",
        event: "Paralympic Debut",
        description: "Para canoe made its Paralympic debut at the Rio Paralympics.",
      },
      {
        year: "2020",
        event: "Event Expansion",
        description: "Additional events were added to the Paralympic program in Tokyo.",
      },
      {
        year: "2024",
        event: "Continued Growth",
        description: "Para canoe continues to grow with more events and participants in Paris.",
      },
    ],
    rules: [
      {
        title: "Race Distance",
        content: "Paralympic para canoe races are held over 200 meters in sprint format.",
      },
      {
        title: "Equipment",
        content: "Athletes use kayaks (K) or va'a (V) boats depending on their classification and preference.",
      },
      {
        title: "Starting",
        content: "Races start from a stationary position with athletes holding onto starting pontoons.",
      },
    ],
    classification:
      "Para canoe has three sport classes: KL1 (no or very limited trunk function), KL2 (partial trunk and leg function), and KL3 (trunk function and partial leg function). Va'a (VL) classes mirror the kayak classifications.",
    pointSystem:
      "Para canoe is a time-based sport where the fastest athlete over the 200-meter distance wins. Races are typically held in heats, semifinals, and finals format.",
    coverImage: "/abstract-geometric-shapes.png",
  }

  const news = getSportNews("para-canoe") || []
  const videos = getSportVideos("para-canoe") || []
                ...
                <div className="grid gap-8 md:grid-cols-2">
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">Kayak (K) and Va'a (V) events</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">200 meters sprint</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">2016 Rio Paralympics</p>
                          </div>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">International Canoe Federation (ICF)</p>
                          </div>
                        </li>
                      </ul>
                    </CardContent>
                  ...
                  <Card className="bg-gray-900 border-gray-800">
                    <CardContent className="p-6">
                      ...
                      <p className="mb-4 text-gray-300">Para canoe uses specialized boats and equipment:</p>
                      <ul className="space-y-2 text-gray-300">
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Kayaks (K) with seat modifications</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Va'a (V) outrigger canoes</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Single-blade paddles for kayak</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-teal-500"></div>
                          <span>Strapping systems for stability</span>
                        </li>
                      </ul>
                    </CardContent>
                  </Card>
