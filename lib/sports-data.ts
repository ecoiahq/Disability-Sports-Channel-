    ...
    timeline: [
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The sport was created at VA hospitals in California and Massachusetts, where injured veterans adapted the
              game of basketball to be played in wheelchairs. Dr. Tim Nugent of the University of Illinois was
              instrumental in promoting the sport.
            </p>
            <div className="mt-3 p-2 bg-gray-800 rounded-md">
              <p className="text-xs text-gray-400 italic">
                "The birth of wheelchair basketball helped change perceptions of disability and demonstrated that
                physical disability did not mean the end of athletic competition."
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              Sir Ludwig Guttmann organized the first Stoke Mandeville Games to coincide with the 1948 London Olympics,
              featuring wheelchair basketball as one of the main events.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The USA won the first gold medal in men's wheelchair basketball at the Rome Paralympics, establishing
              their early dominance in the sport. Only men's competition was held at this time.
            </p>
            <div className="mt-3 grid grid-cols-2 gap-2">
              <div className="bg-gray-800 p-2 rounded-md">
                <p className="text-xs font-medium text-teal-400">Gold</p>
                <p className="text-xs text-gray-300">USA</p>
              </div>
              <div className="bg-gray-800 p-2 rounded-md">
                <p className="text-xs font-medium text-gray-400">Silver</p>
                <p className="text-xs text-gray-300">Great Britain</p>
              </div>
            </div>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              While women's wheelchair basketball began to be played internationally in 1968, it would take nearly three
              decades before it would be included in the Paralympic Games.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The IWBF was established to standardize rules, organize international competitions, and promote the
              development of wheelchair basketball worldwide. Today, it has over 100 member nations.
            </p>
            <div className="mt-3 p-2 bg-gray-800 rounded-md flex items-center justify-center">
              <p className="text-xs text-teal-400 font-medium">
                IWBF Mission: "To encourage and develop the sport of wheelchair basketball for all people with a
                disability."
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              Canada won the first gold medal in women's wheelchair basketball at the Atlanta Paralympics, defeating the
              USA in the final.
            </p>
            <div className="mt-3 grid grid-cols-2 gap-2">
              <div className="bg-gray-800 p-2 rounded-md">
                <p className="text-xs font-medium text-teal-400">Gold</p>
                <p className="text-xs text-gray-300">Canada</p>
              </div>
              <div className="bg-gray-800 p-2 rounded-md">
                <p className="text-xs font-medium text-gray-400">Silver</p>
                <p className="text-xs text-gray-300">USA</p>
      ...
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              Following the success of 3x3 basketball in the Olympic program, the IWBF developed a 3x3 format for
              wheelchair basketball to increase participation and visibility of the sport.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              The first 3x3 Wheelchair Basketball World Championship was held in 2019.
            </p>
          </div>
        ),
      },
    ...
    timeline: [
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              Sir Ludwig Guttmann organized these games for World War II veterans with spinal cord injuries. The events
              primarily included wheelchair racing and throwing events adapted for athletes with paraplegia.
            </p>
            <div className="mt-3 p-2 bg-gray-800 rounded-md">
              <p className="text-xs text-gray-400 italic">
                "The Stoke Mandeville Games were the foundation for what would eventually become the Paralympic
                movement, with athletics at its core."
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The Rome 1960 Paralympic Games featured athletics events for athletes with spinal cord injuries. Events
              included wheelchair racing, javelin, shot put, and club throw.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              113 athletes from 17 countries competed in the first Paralympic Games, with athletics being one of the
              core sports.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The Toronto 1976 Paralympic Games marked a significant evolution in para athletics with the introduction
              of a more structured classification system. This allowed athletes with different types of disabilities to
              compete.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              The Games expanded to include athletes with visual impairments and amputations, greatly diversifying the
              sport.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              Hosted in Stoke Mandeville, UK, these championships were organized by the International Sports
              Organization for the Disabled (ISOD) and marked the first global para athletics competition outside the
              Paralympic Games.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              The event helped establish para athletics as a sport in its own right, with regular competition cycles
              similar to able-bodied athletics.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              This change in governance structure allowed for more consistent rule development, classification, and
              competition management across all para athletics events worldwide.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              The move helped professionalize the sport and align it more closely with World Athletics (formerly IAAF)
              standards.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The rebranding was part of a wider IPC strategy to create distinct identities for Paralympic sports. World
              Para Athletics became the international federation responsible for para athletics globally.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              This period also saw increased integration with able-bodied athletics, with para athletes competing at
              some World Athletics events and Diamond League meetings.
            </p>
            <div className="mt-3 p-2 bg-gray-800 rounded-md">
              <p className="text-xs text-teal-400 font-medium">
                Today, para athletics is practiced in more than 150 countries and is one of the largest sports in the
                Paralympic program.
              </p>
            </div>
          </div>
    ...
    timeline: [
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The Rome 1960 Paralympic Games featured swimming events primarily for athletes with spinal cord injuries.
              The competition was held in a pool at the Acqua Acetosa sports complex.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              Events were limited compared to today's program, with a focus on backstroke and freestyle events that were
              most accessible to athletes with paraplegia.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              Prior to 1984, swimmers were classified strictly by medical diagnosis (e.g., amputee, spinal cord injury).
              The New York/Stoke Mandeville Paralympic Games in 1984 began the shift toward a functional classification
              system.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              This change allowed athletes with different disabilities but similar functional abilities in the water to
              compete against each other, creating more balanced and competitive events.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The Barcelona 1992 Paralympic Games marked the first time the functional classification system was fully
              implemented in para swimming, revolutionizing the sport.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              The system assessed athletes based on their functional ability in the water rather than their medical
              diagnosis, using a point system to evaluate strength, coordination, range of motion, and other factors.
            </p>
            <div className="mt-3 p-2 bg-gray-800 rounded-md">
              <p className="text-xs text-gray-400 italic">
                "The functional classification system was a game-changer for para swimming, creating more equitable
                competition and allowing the sport to grow significantly."
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The IPC assumed direct responsibility for para swimming as the international federation, taking over from
              previous disability-specific organizations.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              This change allowed for more consistent rule development, classification, and competition management
              across all para swimming events worldwide.
            </p>
          </div>
        ),
      },
      {
        ...
        additionalContent: (
          <div>
            <p className="text-sm text-gray-300 mt-2">
              The rebranding was part of a wider IPC strategy to create distinct identities for Paralympic sports. World
              Para Swimming became the international federation responsible for para swimming globally.
            </p>
            <p className="text-sm text-gray-300 mt-2">
              This period also saw increased integration with able-bodied swimming, with some competitions featuring
              both para and able-bodied events.
            </p>
            <div className="mt-3 p-2 bg-gray-800 rounded-md">
              <p className="text-xs text-teal-400 font-medium">
                Today, para swimming is practiced in more than 100 countries and is one of the most popular sports in
